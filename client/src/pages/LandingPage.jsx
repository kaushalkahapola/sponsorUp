    ...
    return (
        <div>
            ...
            <main className='pt-20'>
                {/* TB Image Section */}
                <section className='relative bg-cover bg-center h-screen' style={{ backgroundImage: `url(${TBImage})` }}>
                    ...
                    <img src={BAHImage} alt="Overlay Image" className='absolute top-1/2 right-20 transform -translate-y-1/2 mr-20' />
                </section>
                    ...
                    <div className='container mx-auto px-4'>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                            <div className='order-2 md:order-1'>
                                <img src={MPImage} alt="MP Image" className='mx-auto md:ml-12 md:mr-0 mb-8 md:mb-0 max-w-full' />
                            </div>
                            <div className='order-1 md:order-2 text-center md:text-left'>
                                <p className='text-gray-600 mb-4'>
                                    YOU CAN <br /> <br /> 
                                    <span className='font-bold text-purple-700 text-6xl'>Monitor</span> 
                                    <span className='font-bold text-black text-6xl'> Payments</span> <br /> <br /> 
                                    View real-time updates on successful <br /> payments, refunds, and other transaction-<br />related activities.
                                </p>
                                <a href='#' className='text-purple-700 inline-flex items-center ml-2'> Learn more <ArrowRightIcon className='w-5 h-5 ml-1' /></a>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className='container mx-auto px-4'>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                            <div className='order-1 md:order-2'>
                                <img src={MCImage} alt="MP Image" className='mx-auto md:mr-12 md:ml-0 mb-8 md:mb-0 max-w-full' />
                            </div>
                            <div className='order-2 md:order-1 left-50 text-center md:text-left'>
                                <p className='md:ml-14 text-gray-600 mb-4'>
                                    YOU CAN <br /> <br /> 
                                    <span className='font-bold text-purple-700 text-6xl'>Manage</span> 
                                    <span className='font-bold text-black text-6xl'> Customers</span> <br /> <br /> 
                                    View real-time updates on successful <br /> payments, refunds, and other transaction-<br />related activities.
                                </p>
                                <a href='#' className='text-purple-700 inline-flex items-center ml-14'> Learn more <ArrowRightIcon className='w-5 h-5 ml-1' /></a>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                {/*Payments Section */}
                <section className='relative bg-cover bg-center py-20 md:order-2 mx-auto md:ml-20 md:mr-20 rounded-xl overflow-hidden' style={{ 
                    ...
                    <div className='relative z-10 text-white flex flex-col justify-center items-center h-full'>
                        <div className='max-w mx-auto text-center'>
                            <p className='text-black text-2xl font-bold leading-snug mb-6'>
                                Simplify your business payments with our intuitive tool. Manage, track, <br />
                                and optimize your financial transactions effortlessly. Take control of your <br />
